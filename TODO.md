...
- [ ] **Publish svg_painter_annotation 0.1.0**: Publish annotation package first.
- [ ] **Update svg_painter dependency**: Change `svg_painter_annotation: ^0.0.1-alpha.1` to `^0.1.0`.
