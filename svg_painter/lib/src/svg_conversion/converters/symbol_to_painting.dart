...
/// Extension for <symbol> element conversion.
extension SvgSymbolToPaintCommands on SvgSymbol {
  /// Converts this [SvgSymbol] to a list of [PaintCommand]s.
  Result<List<PaintCommand>> toPaintCommandsSymbol(
