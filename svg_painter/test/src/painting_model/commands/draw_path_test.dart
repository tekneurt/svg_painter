...
void main() {
  group('DrawPath', () {
    test('should return correct string representation when toString() is called', () {
      ...
      expect(
        result,
        'DrawPath(ops: 3, style: PaintingStyle(fill: null, stroke: null, text: null, groupOpacity: 1.0, transform: null, clipRect: null, maskId: null, clipPathId: null, paintOrder: SvgPaintOrder(fill stroke markers)), id: null)',
      );
    });
