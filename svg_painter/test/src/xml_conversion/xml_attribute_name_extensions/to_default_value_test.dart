...
void main() {
  group('ToDefaultValue', () {
    ...
    test('y1 should return 0% for linearGradient and 0.0 for line', () {
      // Arrange & Act & Assert
      expect(XmlAttributeName.y1.toDefaultValue(XmlElementName.linearGradient), const SvgPercentage(0.0));
    ...
    test('x2 should return 100% for linearGradient and 0.0 for line', () {
      // Arrange & Act & Assert
      expect(XmlAttributeName.x2.toDefaultValue(XmlElementName.linearGradient), const SvgPercentage(100.0));
    ...
    test('cx should return 0.0 for circle/ellipse and 50% for radialGradient', () {
      ...
      expect(XmlAttributeName.cx.toDefaultValue(XmlElementName.radialGradient), const SvgPercentage(50.0));
    });
    ...
    test('r should return 0.0 for circle and 50% for radialGradient', () {
      ...
      expect(XmlAttributeName.r.toDefaultValue(XmlElementName.radialGradient), const SvgPercentage(50.0));
    });
    ...
    test('points should return empty SvgPointList', () {
      // Arrange & Act & Assert
      expect(XmlAttributeName.points.toDefaultValue(XmlElementName.polygon), const SvgPointList(<double>[]));
    });
    ...
    test('fill should return none for line and black for others', () {
      ...
      expect(XmlAttributeName.fill.toDefaultValue(XmlElementName.circle), const SvgNamedColor(SvgColorName.black));
    });
    ...
    test('stroke attributes should return correct defaults', () {
      ...
      expect(XmlAttributeName.strokeWidth.toDefaultValue(XmlElementName.circle), const SvgLength(1.0));
      expect(XmlAttributeName.strokeLinecap.toDefaultValue(XmlElementName.circle), SvgStrokeLinecap.butt);
      expect(XmlAttributeName.strokeLinejoin.toDefaultValue(XmlElementName.circle), SvgStrokeLinejoin.miter);
    });
    ...
    test('gradient stop attributes should return correct defaults', () {
      ...
      expect(XmlAttributeName.stopColor.toDefaultValue(XmlElementName.stop), const SvgNamedColor(SvgColorName.black));
      expect(XmlAttributeName.stopOpacity.toDefaultValue(XmlElementName.stop), const SvgLength(1.0));
    });
    ...
    test('opacity attributes should return 1.0', () {
      ...
      expect(XmlAttributeName.fillOpacity.toDefaultValue(XmlElementName.path), const SvgLength(1.0));
      expect(XmlAttributeName.strokeOpacity.toDefaultValue(XmlElementName.path), const SvgLength(1.0));
    });

    test('radialGradient specific attributes should return correct defaults', () {
      // Arrange & Act & Assert
      expect(XmlAttributeName.fx.toDefaultValue(XmlElementName.radialGradient), const SvgPercentage(50.0));
      expect(XmlAttributeName.fy.toDefaultValue(XmlElementName.radialGradient), const SvgPercentage(50.0));
      expect(XmlAttributeName.fr.toDefaultValue(XmlElementName.radialGradient), const SvgPercentage(0.0));
    });

    test('attributes without SvgBaseValue default should throw UnsupportedError', () {
      // Arrange & Act & Assert
      expect(() => XmlAttributeName.viewBox.toDefaultValue(XmlElementName.svg), throwsUnsupportedError);
      expect(() => XmlAttributeName.d.toDefaultValue(XmlElementName.path), throwsUnsupportedError);
      expect(() => XmlAttributeName.id.toDefaultValue(XmlElementName.circle), throwsUnsupportedError);
    });
  });
}
