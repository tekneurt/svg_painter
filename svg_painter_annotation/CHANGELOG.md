...
- **Documentation**: Comprehensive README rewrite detailing file and code constructors, exposure modes, and property mappings.
- **Dependencies**: Broadened `meta` constraint to `">=1.17.0 <2.0.0"`.
