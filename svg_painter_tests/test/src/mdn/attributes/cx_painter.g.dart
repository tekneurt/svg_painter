...
class _$CxPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final FittedSizes fittedSizes = applyBoxFit(fit, const Size(300.0, 100.0), size);
    ...
    }
    {
      ...
      paint.style = PaintingStyle.fill;
      canvas.drawOval(
        Rect.fromCenter(center: const Offset(150.0, 50.0), width: 90.0, height: 50.0),
        paint,
      );
    }
    {
      final Paint paint = Paint();
      paint.shader = _grad_myGradient.createShader(Rect.fromLTWH(205.0, 5.0, 90.0, 90.0));
      paint.style = PaintingStyle.fill;
