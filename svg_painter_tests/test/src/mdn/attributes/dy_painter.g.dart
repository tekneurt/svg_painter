...
class DyPainterWidget extends StatelessWidget {
  const DyPainterWidget({
    super.key,
    this.width,
    this.height,
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      painter: _$DyPainter(fit: fit),
    );
  }
}

class _$DyPainter extends CustomPainter {
  const _$DyPainter({this.fit = BoxFit.contain});
  ...
  @override
  bool shouldRepaint(covariant _$DyPainter oldDelegate) {
