...
part of 'preserve_aspect_ratio_4_painter.dart';
...
class PreserveAspectRatio4PainterWidget extends StatelessWidget {
  const PreserveAspectRatio4PainterWidget({
    super.key,
    this.width,
    this.height,
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      painter: _$PreserveAspectRatio4Painter(fit: fit),
    );
  }
}

class _$PreserveAspectRatio4Painter extends CustomPainter {
  const _$PreserveAspectRatio4Painter({this.fit = BoxFit.contain});
  ...
  @override
  bool shouldRepaint(covariant _$PreserveAspectRatio4Painter oldDelegate) {
