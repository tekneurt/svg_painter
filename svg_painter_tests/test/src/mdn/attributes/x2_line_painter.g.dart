...
class X2LinePainterWidget extends StatelessWidget {
  const X2LinePainterWidget({
    super.key,
    this.width,
    this.height,
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      painter: _$X2LinePainter(fit: fit),
    );
  }
}
    ...
    {
      {
        ...
        canvas.drawLine(const Offset(5.0, 1.0), const Offset(1.0, 9.0), paint);
      }
      {
        final Paint paint = Paint();
    ...
    {
      {
        ...
        paint.color = Colors.black;
        paint.style = PaintingStyle.fill;
        canvas.drawLine(const Offset(5.0, 1.0), const Offset(9.0, 9.0), paint);
      }
      {
        final Paint paint = Paint();
