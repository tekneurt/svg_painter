...
class XTextPainterWidget extends StatelessWidget {
  const XTextPainterWidget({
    super.key,
    this.width,
    this.height,
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      painter: _$XTextPainter(fit: fit),
    );
  }
}

class _$XTextPainter extends CustomPainter {
  const _$XTextPainter({this.fit = BoxFit.contain});
  ...
  @override
  bool shouldRepaint(covariant _$XTextPainter oldDelegate) {
