...
class XTspanPainterWidget extends StatelessWidget {
  const XTspanPainterWidget({
    super.key,
    this.width,
    this.height,
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      painter: _$XTspanPainter(fit: fit),
    );
  }
}

class _$XTspanPainter extends CustomPainter {
  const _$XTspanPainter({this.fit = BoxFit.contain});
    ...
    }
    {
      ...
      paint.style = PaintingStyle.fill;
      {
        ...
        tp.paint(
          ...
          Offset(
            0.0,
            0.0 - tp.computeDistanceToActualBaseline(TextBaseline.alphabetic),
          ),
        );
      }
    }
  ...
  @override
  bool shouldRepaint(covariant _$XTspanPainter oldDelegate) {
