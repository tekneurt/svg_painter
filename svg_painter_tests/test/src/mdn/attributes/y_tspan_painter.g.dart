...
class YTspanPainterWidget extends StatelessWidget {
  const YTspanPainterWidget({
    super.key,
    this.width,
    this.height,
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      painter: _$YTspanPainter(fit: fit),
    );
  }
}

class _$YTspanPainter extends CustomPainter {
  const _$YTspanPainter({this.fit = BoxFit.contain});
  ...
  @override
  bool shouldRepaint(covariant _$YTspanPainter oldDelegate) {
