...
_fixtures =
    ...
    >[
      ...
      (
        painter: const EllipsePainter(),
        name: 'ellipse_painter',
        tests: defaultGoldenTests,
        widget: null,
        nativeSize: null,
      ),
      ...
      (
        painter: const PolygonPainter(),
        name: 'polygon_painter',
        tests: defaultGoldenTests,
        widget: null,
        nativeSize: null,
      ),
      (
        painter: const PolylinePainter(),
        name: 'polyline_painter',
        tests: defaultGoldenTests,
        widget: null,
        nativeSize: null,
      ),
