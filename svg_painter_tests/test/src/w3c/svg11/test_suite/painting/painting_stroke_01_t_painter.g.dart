...
part of 'painting_stroke_01_t_painter.dart';
...
class PaintingStroke01TPainterWidget extends StatelessWidget {
  const PaintingStroke01TPainterWidget({
    super.key,
    this.width,
    this.height,
  ...
  Widget build(BuildContext context) {
    return Semantics(
      label: '\$RCSfile: painting-stroke-01-t.svg,v \$',
      child: CustomPaint(
        size: Size(width ?? 480.0, height ?? 360.0),
        painter: _$PaintingStroke01TPainter(fit: fit),
      ),
    );
  }
}

class _$PaintingStroke01TPainter extends CustomPainter {
  const _$PaintingStroke01TPainter({this.fit = BoxFit.contain});
      ...
      paint.style = PaintingStyle.fill;
      {
        final TextPainter tp = TextPainter(
          text: TextSpan(
            ...
            children: <InlineSpan>[TextSpan(text: 'stroke="none"')],
          ),
          textDirection: TextDirection.ltr,
        )..layout();
        tp.paint(
      ...
      paint.style = PaintingStyle.fill;
      {
        final TextPainter tp = TextPainter(
          text: TextSpan(
            ...
            children: <InlineSpan>[TextSpan(text: 'stroke="green"')],
          ),
          textDirection: TextDirection.ltr,
        )..layout();
        tp.paint(
  ...
  @override
  bool shouldRepaint(covariant _$PaintingStroke01TPainter oldDelegate) {
